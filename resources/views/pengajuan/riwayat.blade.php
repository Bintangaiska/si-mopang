<x-app-layout>
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="simopang-card p-6">
                <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3 mb-4">
                    <div>
                        <h3 class="text-sm font-semibold text-white">RIWAYAT PENGAJUAN ANGGARAN</h3>
                        <p class="text-xs text-polri-silver-dark mt-1">Menampilkan semua pengajuan yang pernah Anda ajukan</p>
                    </div>
                    <div class="flex gap-2">
                        <input type="text" id="searchRiwayat" placeholder="Cari uraian, urusan..." class="simopang-input text-sm px-3 py-1.5">
                    </div>
                </div>

                <div class="overflow-x-auto">
                    <table class="w-full text-sm text-left" id="riwayatTable">
                            ...
                            <tr>
                                <td colspan="8" class="py-12 text-center">
                                    <div class="flex flex-col items-center gap-2">
                                        ...
                                        <p class="text-polri-silver-dark text-sm">Belum ada pengajuan.</p>
                                        <a href="{{ route('pengajuan.create') }}" class="simopang-btn-primary text-xs mt-1">Ajukan Sekarang</a>
                                    </div>
                                </td>
                            </tr>
                            @endforelse
                ...
                <p class="text-xs text-polri-silver-dark mt-3" id="riwayatInfo"></p>
            </div>
        </div>
    </div>
    ...
    <script>
        ...
        const rows = document.querySelectorAll('#riwayatTable .table-row');
